...
public class TextViewTypeFace extends TextView {
    ...
    public TextViewTypeFace(final Context context) {
        this(context, null);
    }

    public TextViewTypeFace(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TextViewTypeFace(final Context context, final AttributeSet attrs, final int defStyle) {
